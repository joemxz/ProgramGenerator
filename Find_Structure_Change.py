...
progfound=0
cont_rout=0
general_prog = open("USCNEL001.L5X", "r")
...
prog2 =[]
task_string=""
general2_prog = open("USCNEL001.L5X", "r")
...
for line in proginit:
    ...
    if line.find('<Programs>') >= 0 and progfndtemp == 1:
            routinesfound = 1
    if line.find('<Routines>') >= 0 and routfndtemp == 1:
            routinesfound = 1
PinitNewFile_content += "\n"
PcloseNewFile_content += "\n"
proginit.close()
